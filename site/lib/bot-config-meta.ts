...
export const BOT_MODULE_META: Record<BotConfigModule, { icon: IconName; name: string; description: string }> = {
    ...
    tickets: { icon: "ticket", name: "Configurar Ticket", description: "Categorias, mensagens e equipe" },
    ...
    cloud: { icon: "apps", name: "ZurosCloud", description: "OAuth2, verificação, tarefas e presentes" },
    ...
    extensions: { icon: "apps", name: "Extensões", description: "Zuros Gen e Zuros Boost" },
};
