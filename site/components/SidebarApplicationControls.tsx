    ...
    return <>
        <div className="mt-4 lg:hidden">
            <div className="flex items-center gap-4 rounded-2xl border border-white/[.08] bg-[#101014] p-4 shadow-xl shadow-black/20">
                <span className="grid h-14 w-14 shrink-0 place-items-center overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface-raised)]"><BrandLogo compact className="h-11 w-11" /></span>
        ...
        <div className="mt-4 hidden shrink-0 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3 lg:block">
