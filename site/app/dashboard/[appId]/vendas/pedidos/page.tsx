...
export default async function PedidosPage({ params }: { params: { appId: string } }) {
    await requireUser();
    ...
    const orders = await listOrders(params.appId);
    ...
    return (
        <main className="mx-auto max-w-6xl px-5 py-8">
            ...
            <OrdersList appId={params.appId} initial={orders} />
        </main>
    );
}
