...
export default async function AccountExtractsPage() {
    ...
    return (
        <main className="mx-auto max-w-6xl px-5 py-10">
            <div className="flex items-center gap-2.5"><span className="h-6 w-1 rounded-full bg-[var(--accent)]" /><h1 className="text-3xl font-semibold tracking-tight text-white">Extrato</h1></div>
