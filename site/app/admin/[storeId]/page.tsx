...
export default async function StoreOverviewPage({ params }: { params: { storeId: string } }) {
    const stats = await getStoreStats(params.storeId);
    const extracts = await getStoreExtracts(params.storeId, 10);
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <ActivityFeed storeId={params.storeId} />
            <TelemetryDashboard />
