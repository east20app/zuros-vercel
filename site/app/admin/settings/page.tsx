...
export default async function AdminSettingsPage() {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <Card className="flex flex-col gap-4"><h2 className="flex items-center gap-2 text-sm font-semibold text-white"><span className="h-4 w-1 rounded-full bg-[var(--accent)]" />Certificado EFI</h2><p className="text-xs text-zinc-500">Equivalente ao comando /enviarcertificado. Aceita .p12, .pfx e .pem até 5 MB.</p><CertificateUploader /></Card>

            {identity ? (
                <Card className="flex flex-col gap-4 border-[var(--border)]">
                    <div>
                        <h2 className="flex items-center gap-2 text-sm font-semibold text-white"><span className="h-4 w-1 rounded-full bg-[var(--accent)]" />Integração da infraestrutura</h2>
            ...
            <div className="grid gap-6">
                <Card className="flex flex-col gap-4">
                    <h2 className="flex items-center gap-2 text-sm font-semibold text-white"><span className="h-4 w-1 rounded-full bg-[var(--accent)]" />Pagamento</h2>
            ...
            {identity ? (
                <Card className="flex flex-col gap-4">
                    <h2 className="flex items-center gap-2 text-sm font-semibold text-white"><span className="h-4 w-1 rounded-full bg-[var(--accent)]" />Identidade do bot no Discord</h2>
                    <p className="text-xs text-zinc-500">
            ...
            <Card className="flex flex-col gap-3">
                <h2 className="flex items-center gap-2 text-sm font-semibold text-white"><span className="h-4 w-1 rounded-full bg-[var(--accent)]" />Suas lojas</h2>
