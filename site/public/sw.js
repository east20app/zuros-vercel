...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(self.registration.showNotification(data.title, { body: data.body, icon: "/brand/icon.png", badge: "/brand/icon.png", data: { url: data.url }, tag: data.tag || "zuros-update" }));
});
