...
{
    'type': 'dnd',
    'names': ['Drox Bot', 'Gerenciando', 'Online 24/7']
}
```
...
// Atualizar status
await axios.post('https://cloud.zurosapplications.com.br/api/functions/execute', {
  botId: 'DroxBot8',
  function: 'customization.updateStatus',
  params: {
    type: 'dnd',
    names: ['Drox Bot', 'Em manutenção']
  }
});
