...
def _get_automation_options():
        return [
                            ...
                            disnake.SelectOption(label="DroxAI Chat", value="ia_chat", description="Tenha um chat com IA em seu servidor", emoji=emoji.double_speech),
                            disnake.SelectOption(label="DroxAI Moderator", value="filtro_tos", description="Tenha um moderador com IA em seu servidor", emoji=emoji.sparkles),
    ...
    def PainelComponents() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                ...
                disnake.ui.TextDisplay("Gerencie as opções de automações do seu **Drox Bot**."),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
