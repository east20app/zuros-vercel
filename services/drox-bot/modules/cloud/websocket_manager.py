...
class WebSocketManager:
    ...
    def __init__(self, server_url: str = "https://cloud.zurosapplications.com.br", reconnect_interval: int = 5):
    ...
    def set_bot(self, bot):
        ...
        try:
            with open('config.json', 'r', encoding='utf-8') as f:
                config = json.load(f)
                self.bot_unique_id = config.get("botID", "DroxBot")
    ...
    def _validate_event_ownership(self, data: dict) -> bool:
        ...
        try:
            ...
            return False  # Fail-closed: ownership não confirmado
    ...
    async def send_synchronization(self, bot_id: str, zuros_data: Dict[str, Any]) -> Dict[str, Any]:
        """Envia dados de sincronização"""
        data = {"botId": bot_id, "data": zuros_data}
