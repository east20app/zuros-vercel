...
class StockManager:
    ...
    # Evita perda de atualizações quando duas entregas ocorrem no mesmo
    # processo. A persistência distribuída ainda deve usar transações no
    # adaptador do banco quando houver mais de uma instância do bot.
