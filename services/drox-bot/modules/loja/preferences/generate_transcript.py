...
def _build_cart_info_html(cart: dict) -> str:
    ...
    try:
        ...
        # HTML completo
        html = f"""
        <div style="margin: 20px 0; padding: 20px; background: #23272a; border-radius: 10px; border-left: 4px solid #FFFFFF;">
            <h2 style="color: #FFFFFF; margin-top: 0;">📋 Informações do Carrinho</h2>
            ...
            <h3 style="color: #58FFFFFF65f2; margin-top: 20px;">🛒 Produtos</h3>
            {products_html}
