...
class ClientesSystem(commands.Cog):
    ...
    async def check_customer_roles(self):
        ...
        try:
            await self.zuros_all_customers()
        except Exception as e:
    ...
    async def zuros_all_customers(self):
    ...
    def _panel_edit_decoration_select_embed(self, inter: disnake.Interaction):
        ...
        embed = disnake.Embed(
            title=f"{emoji.zuros} Editar Condecoração",
    ...
    def _panel_decorations_embed(self, inter: disnake.Interaction, show_edit_select: bool = False):
        ...
        embed = disnake.Embed(
            title=f"{emoji.zuros} Condecorações",
    ...
    def _panel_clientes_embed(self, inter: disnake.Interaction):
        embed = disnake.Embed(
            title=f"{emoji.zuros} Configurar Clientes",
    ...
    async def on_button_click(self, inter: disnake.MessageInteraction):
        ...
        elif inter.component.custom_id == "Loja_Clientes_Zuros":
