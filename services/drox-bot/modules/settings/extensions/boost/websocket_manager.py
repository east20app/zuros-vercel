"""
Boost WebSocket Manager for Drox Bot
...
class BoostWebSocketManager:
    ...
    def __init__(self, server_url: str = "wss://boost.zurosapplications.com.br", reconnect_interval: int = 5):
        ...
        try:
            ...
            try:
                with open('config.json', 'r', encoding='utf-8') as f:
                    config = json.load(f)
                    unique_id = config.get("botID", "DroxBot")
            except Exception:
                unique_id = "DroxBot"
