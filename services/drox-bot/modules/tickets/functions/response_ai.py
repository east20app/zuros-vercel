...
BASE_PROMPT = """
Você é DroxAI, uma assistente virtual amigável e prestativa da Drox. Seu papel é oferecer suporte inicial aos usuários, respondendo às dúvidas de forma clara, concisa e natural.

### Regras Invioláveis:
- **Identidade:** Você é uma assistente virtual chamada DroxAI. Nunca se descreva como 'IA', 'chatbot' ou 'modelo de linguagem'. Você é a DroxAI, um modelo da Drox.
...
class TicketAIResponder(commands.Cog):
    ...
    async def ai_on_ticket_message(self, message: disnake.Message):
        ...
        if is_atendente:
            ...
            message_content = (
                f"{emoji.wand} **DroxAI pausada para este ticket.**\n"
