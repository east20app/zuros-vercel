...
from ...transcripts.host_transcript import log_transcript
...
async def close_ticket(bot: commands.Bot, channel: disnake.TextChannel, closed_by: disnake.Member, reason: str = None, inter: disnake.Interaction = None):
    ...
    # Gera o transcript antes de deletar o canal
    ...
    # Envia o transcript respondendo à mensagem de log de fechamento
    if transcript_file and closure_log_message:
        await log_transcript(bot, transcript_file, message_to_reply=closure_log_message)
    ...
    if ticket_owner and send_dm_enabled:
        ...
        if send_transcript and transcript_file:
