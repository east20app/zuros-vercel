...
class WebSocketManager:
    """Manager for WebSocket connection to Zuros API Manager"""
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.server_url = self.config.get('websocket_manager', {}).get('server_url', 'https://manager.zurosapplications.com.br')
