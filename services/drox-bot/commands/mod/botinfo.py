...
class BotInfo(commands.Cog):
    ...
    async def on_message(self, message: disnake.Message):
        ...
        contains_name = "zuros" in message.content.lower()
        ...
        if is_mention:
            ...
            info_text_list = [
                f"{emoji.chevron} **Bot desenvolvido pela [Drox](https://api.zurosapplications.com.br)**",
            ...
            buttons = disnake.ui.ActionRow(
                disnake.ui.Button(label="Dashboard", url=f"https://api.zurosapplications.com.br"),
                disnake.ui.Button(label="Servidor de Suporte", url=f"https://api.zurosapplications.com.br/socials/discord"),
            )
            ...
            try:
                await message.add_reaction(emoji.zuros)
