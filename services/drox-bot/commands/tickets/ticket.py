...
from modules.tickets.functions.permissions import check_attendant_permissions as setup_check_perms
...
class TicketCommands(commands.Cog):
    ...
    @ticket.sub_command(name="atendente", description="Exibe o painel de gerenciamento para a equipe de atendimento em um ticket.")
    async def atendente(self, inter: disnake.ApplicationCommandInteraction):
        ...
        has_permission = await setup_check_perms(inter.author, inter.channel.id)
        if not has_permission:
    ...
    @ticket.sub_command(name="usuario", description="Exibe o painel de gerenciamento para o usuário em um ticket.")
